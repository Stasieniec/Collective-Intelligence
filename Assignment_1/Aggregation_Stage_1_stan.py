...
class AggregationConfig(Config):
    ...
    mass: int = 20
    movement_speed: float = 15                      # Velocity of the Agents
    ...
    t_join_base: float = 1.0                       # The base time steps before stopping
    t_join_noise: float = 0.1                       # The gaussian noise added to the base time steps
    p_base_leaving: float = 0.1                     # Old
    p_base_joining: float = 1.4                     # Old
    a: float = 1                                  # New value for joining probability
    b: float = 1                                  # New value for leaving probability
